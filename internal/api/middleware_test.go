...
func TestRateLimiterBasic(t *testing.T) {
	rateLimiter, _ := RateLimiter(2, time.Minute)
...
func TestRateLimiterDifferentIPs(t *testing.T) {
	rateLimiter, _ := RateLimiter(1, time.Minute)
	handler := rateLimiter(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
...
func TestRateLimiterTokenRefill(t *testing.T) {
	rateLimiter, _ := RateLimiter(1, 100*time.Millisecond)
	handler := rateLimiter(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
...
func TestRateLimiterConcurrency(t *testing.T) {
	...
	rateLimiter, _ := RateLimiter(100, time.Minute)
	handler := rateLimiter(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
...
func TestRateLimiterCleanup(t *testing.T) {
	rateLimiter, _ := RateLimiter(1, 50*time.Millisecond)
	handler := rateLimiter(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
...
func BenchmarkRateLimiter(b *testing.B) {
	rateLimiter, _ := RateLimiter(1000, time.Minute)
	handler := rateLimiter(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
