# Makefile for Analytics - Privacy-focused web analytics service
# Usage: make [target]
...
.PHONY: help
help:
	@echo "$(COLOR_BOLD)Analytics - Privacy-focused web analytics service$(COLOR_RESET)"
	@echo ""
